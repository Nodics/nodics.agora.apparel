...
export const runtimeConfig: AgoraRuntimeConfig = Object.freeze({
  ...
  wcmsExperienceBaseUrl:
    import.meta.env.VITE_STOREFRONT_WCMS_EXPERIENCE_BASE_URL ??
    import.meta.env.VITE_STOREFRONT_CMS_BASE_URL ??
    "http://localhost:4314",
  mediaBaseUrl:
    import.meta.env.VITE_STOREFRONT_MEDIA_BASE_URL ?? "http://localhost:4314",
  axisBaseUrl:
    import.meta.env.VITE_STOREFRONT_AXIS_BASE_URL ?? "http://localhost:3100",
  profileBaseUrl:
  ...
  currency: import.meta.env.VITE_STOREFRONT_CURRENCY ?? "USD",
